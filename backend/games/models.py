...
class Game(models.Model):
    ...
    game_quiz = models.OneToOneField(Quiz, null=True, on_delete=models.CASCADE, )
...
class PlayerAnswerList(models.Model):
    ...
    answers = models.CharField(validators=[validate_comma_separated_integer_list],max_length=100)

    def __str__(self):
        return f'{self.player.email}: {self.game.game_quiz.name} Answers'